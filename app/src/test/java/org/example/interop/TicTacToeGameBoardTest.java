...
public class TicTacToeGameBoardTest {
    ...
    @Test
    public void should_place_playerMarker_at_specified_location() {
    ...
    @Test
    public void should_return_null_when_playerMarker_is_not_placed_at_specified_location() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        var updatedGameBoard = gameBoard.withMove("X", 4);
        assertTrue(updatedGameBoard instanceof TicTacToeGameBoard);
        switch (updatedGameBoard) {
    ...
    @Test
    public void should_validate_move_is_possible() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        var updatedGameBoard = gameBoard.withMove("X", 4);
        switch (updatedGameBoard) {
            case TicTacToeGameBoard b:
    ...
    @Test
    public void should_check_empty_board_has_moves_available() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        assertTrue(gameBoard.hasMovesAvailable());
    }

    @Test
    public void should_check_full_board_has_no_moves_available() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        for (int i = 0; i < 9; i++) {
            assertTrue(gameBoard.hasMovesAvailable());
    ...
    @Test
    public void should_check_board_for_player_with_winning_chain() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
    ...
    @Test
    public void should_represent_board_as_string() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        gameBoard = gameBoard.withMove("X", 0);
        gameBoard = gameBoard.withMove("O", 5);
        gameBoard = gameBoard.withMove("X", 1);
    ...
    @Test
    public void should_represent_empty_board_as_string() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        assertEquals(gameBoard.toString(), "_ _ _\n_ _ _\n_ _ _\n");
    }

    @Test
    public void should_represent_board_as_json_string() {
        var gameBoard = ticTacToeLibrary.newGameBoard(3);
        gameBoard = gameBoard.withMove("X", 0);
        gameBoard = gameBoard.withMove("O", 5);
        gameBoard = gameBoard.withMove("X", 1);
