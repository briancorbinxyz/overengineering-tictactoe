...
/**
 * Tests the functionality of the KyberKEMSpi class, which is an implementation of the Kyber Key
 * Encapsulation Mechanism (KEM) algorithm.
 *
 * <p>The tests cover the following scenarios: - Verifying that a new instance of KyberKEMSpi can be
 * created successfully. - Verifying that the Kyber KEM algorithm can be loaded and used through the
 * Java Security API.
 *
